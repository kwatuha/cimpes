  ...
  const handleFormSubmit = async () => {
    ...
    try {
      if (currentContractorToEdit) {
        ...
        const newContractor = await apiService.contractors.createContractor(formData);
        
        // Link contractor to user if a user was selected
        if (formData.userId) {
          await apiService.contractors.linkToUser(newContractor.contractorId, formData.userId);
        }
