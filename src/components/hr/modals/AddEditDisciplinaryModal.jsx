      ...
      <DialogContent dividers>
        <form onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6}>
              <TextField fullWidth margin="dense" name="actionDate" label="Action Date" type="date" value={formData?.actionDate?.slice(0, 10) || ''} onChange={handleFormChange} required InputLabelProps={{ shrink: true }} />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField fullWidth margin="dense" name="reason" label="Reason" type="text" multiline rows={2} value={formData?.reason || ''} onChange={handleFormChange} required />
            </Grid>
            <Grid item xs={12}>
